...
class GameFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        viewModel.buzz.observe(viewLifecycleOwner, Observer { newBuzz -> buzz(newBuzz.pattern) })
        ...
        viewModel.formattedTimer.observe(viewLifecycleOwner, Observer { newTimer -> binding.timerText.text = newTimer.toString() })*/
     ...
     */
    private fun gameFinished(status : Boolean) {
        if(status) {
    ...
    private fun buzz(pattern: LongArray) {
        Log.i("GameFragment","BuzzerCalled")
